...
import { AlertCircle, Phone, MapPin, Briefcase, FileText, User } from "lucide-react";
...
const CarteMembre = () => {
  ...
  // Parse cahier de charges into bullet points
  const cahierItems = member?.cahier_charges
    ? member.cahier_charges
        .split(".")
        .map((s: string) => s.trim())
